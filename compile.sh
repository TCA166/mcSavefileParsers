...
gcc regionFileReader.c regionParser.o -o regionFileReader -lz -lm -static "$@" #utility 1
...
gcc radiusGenerator.c generator.o model.o regionParser.o hTable.o chunkParser.o nbt_parsing.o nbt_treeops.o buffer.o nbt_util.o -lz -lm -static "$@" -o radiusGenerator